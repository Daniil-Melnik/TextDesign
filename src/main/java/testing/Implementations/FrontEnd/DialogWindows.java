...
public class DialogWindows {
    ...
    /**
     * Получает диалоговое окно добавления текста.
     * @param f родительское окно
     * @param i индекс (не используется)
     * @return окно выбора гарнитуры
     */
    ...
    /**
     * Получает диалоговое окно выбора цвета.
     * @param f родительское окно
     * @param t тип выбора цвета
     * @param currColor текущий цвет
     * @return окно выбора цвета
     */
    ...
    /**
     * Получает диалоговое окно выбора размера шрифта.
     * @param f родительское окно
     * @param i начальный индекс
     * @return окно выбора размера
     */
    ...
    /**
     * Диалоговое окно выбора гарнитуры шрифта.
     */
    public static class TextAdder extends JPanel {
        ...
        /**
         * Получает список шрифтов из файла.
        ...
        public boolean showDialog() {
            if (dialog == null) {
                ...
                dialog.setIconImage(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/fonts.png"))
                ).getImage());
    ...
    /**
     * Диалоговое окно выбора размера шрифта.
     */
    public static class TextSizeChooser extends JPanel {
         ...
         * @return выбранный размер шрифта
         */
        ...
        public boolean showDialog() {
            if (dialog == null) {
                ...
                dialog.setIconImage(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/text-width.png"))
                ).getImage());
    ...
    public static class TextColorChooser extends JPanel {
        ...
        private static final int[][] colors = {
                {51,0,0}, {51,25,0}, {51,51,0}, {0,51,0}, {0,51,25},
                {0,51,51}, {0,0,51}, {25,0,51}, {51,0,51}, {0,0,0},
                {153,0,0}, {153,76,0}, {153,153,0}, {0,153,0}, {0,153,76},
                {0,153,153}, {0,0,153}, {76,0,153}, {153,0,153}, {64,64,64},
                {255,0,0}, {255,128,0}, {255,255,0}, {0,255,0}, {0,255,128},
                {0,255,255}, {0,0,255}, {127,0,255}, {255,0,255}, {128,128,128}
        };
        ...
        public boolean showDialog() {
            if (dialog == null) {
                ...
                dialog.setIconImage(new ImageIcon(
                        Objects.requireNonNull(this.getClass().getResource("/palette.png"))
                ).getImage());
            }
            dialog.setVisible(true);
            return ok;
    ...
    /**
     * Кастомная кнопка с заданными параметрами.
     */
